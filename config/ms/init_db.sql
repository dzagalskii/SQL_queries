...
if not exists (   select * from sys.tables where name='P'  )
create table P
(
	PN int,
...
if not exists (   select * from sys.tables where name='J'  )
create table J
(
	JN int,
...
if not exists (   select * from sys.tables where name='SPJ'  )
create table SPJ
(
	SN int,
	PN int,
...
if not exists (   select * from sys.tables where name='SPJ2'  )
create table SPJ2
(
	SN int,
	PN int,
